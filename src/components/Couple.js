        ...
        return (
            <div style={{ marginLeft: '2%', marginRight: '2%' }}>
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-6">
                        <p>It all started 10 years back at the dumbest phase of life and career. They never knew it will go this far. And marriage whooaa <span role="img" aria-label="">😱</span>&nbsp; they never thought of it. All they like was each others company. After getting settled and luckily in the same city <img src="img/city.png" className="cityIcon" alt="Bengaluru" />, the destiny wrote a new chapter in their life. Having travelled together a lot they love trying different cuisines. Irish Coffee (like real Irish <span role="img" aria-label="">😉</span>&nbsp;) with Crepe is something they love always.</p>
                        <p>Girl is studious <span role="img" aria-label="">🤓</span>&nbsp;, But she would rather boast off her running feats <span role="img" aria-label="">🏃🏻‍</span>&nbsp; and sports medals than her high scores. She is moody like a princess <span role="img" aria-label="">👸</span>&nbsp; and the unplanned dates make her happy. She loves keeping her fit and having watches and shoes.</p>
                        <p>Boy has always been looked upon as a sincere and silent type. He likes to imagine himself as Sherlock. Well his childhood dream was to be detective <span role="img" aria-label="">🤠</span>&nbsp; He loves Badminton and swimming. Ahhhaaa I have never seen him bored. He is foody and has a highly adaptable taste <span role="img" aria-label="">😋</span>&nbsp;.</p>
                        <p>Besides being so different both of them love travelling together, Watching Action and SciFi movies, sometimes doing absolutely nothing and oo Yea trying different foods together. More than a couple they are buddies <span role="img" aria-label="">👫</span>&nbsp;.</p>
                    </div>
                </div>
            </div>
        );
